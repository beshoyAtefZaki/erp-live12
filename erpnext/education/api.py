...
def enroll_student(source_name):
    ...
    student.save()
    sta = get_mapped_doc("Student Applicant", source_name,
        {"Student Applicant": {
    ...
    program_enrollment.academic_year = sta.academic_year
    program_enrollment.academic_term = sta.academic_term
    program_enrollment.follow_up = sta.follow_up
    program_enrollment.courses = sta.courses
    program_enrollment.total_commission_sp = sta.total_commission_sp
...
def get_fee_components(fee_structure):
    ...
    """
    if fee_structure:
        fs = frappe.get_list("Fee Component", fields=["fees_category", "amount"], filters={"parent": fee_structure},
                             order_by="idx")
        return fs
...
def get_assessment_details(assessment_plan):
    ...
    return frappe.get_list("Assessment Plan Criteria", \
                           ...
                           filters={"parent": assessment_plan}, order_by="idx")
...
def get_grade(grading_scale, percentage):
    ...
    if not hasattr(frappe.local, 'grading_scale'):
        grading_scale = frappe.get_all("Grading Scale Interval", fields=["grade_code", "threshold"],
