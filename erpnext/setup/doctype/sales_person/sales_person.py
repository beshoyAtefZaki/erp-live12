...
class SalesPerson(NestedSet):
	...
	def on_update(self):
		...
		if frappe.db.exists("User", {"name": employee.user_id}):
			user = frappe.get_doc("User", {"name": employee.user_id})
			user.sales_person = self.name
			user.save()
		else:
			frappe.msgprint("Please Set User For Employee")
