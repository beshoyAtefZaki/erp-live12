...
class ItemPrice(Document):
	...
	def update_last_transaction(self):
		item_price = frappe.get_doc("Item Price", {"item_code": self.item_code}, {"price_list": self.price_list}, {"valid_from": ("<", self.valid_from)})
		frappe.db.set_value("Item Price", item_price.name, "valid_upto", self.valid_from)
		#item_price.valid_upto = self.valid_from
		#item_price.save()
	"""
